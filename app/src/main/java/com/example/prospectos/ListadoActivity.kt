...
import com.example.prospectos.Adapter.ProspectListAdapter
...
class ListadoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val prospectList = retrieveProspectsFromDatabase()
        val adapter = ProspectListAdapter(this, prospectList)
        listView.adapter = adapter

        listView.setOnItemClickListener { _, _, position, _ ->
            val selectedProspect = prospectList[position]
            val intent = Intent(this, DetalleProspectoActivity::class.java)
            intent.putExtra("prospect", selectedProspect)
